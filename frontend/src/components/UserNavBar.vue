<template>
  ...
  <div v-if="getIsVolunteer">
      <nav class="navbar navbar-expand-lg navbar-light bs-side-navbar justify-content-start" style="background-color: orange;" id="navbarContainer">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                  <li class="nav-item">
                      <router-link to="/volunteer" class="item"><i class="bi bi-calendar3 me-1"></i> Volunteer</router-link>
                  </li>
                  <!-- my events -->
                  <li class="nav-item">
                      <router-link to="" class="item"><i class="bi bi-piggy-bank me-1"></i> My Events</router-link>
                  </li>
                  <li class="nav-item">
